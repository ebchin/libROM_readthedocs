...
if read_the_docs_build:
    ...
    call('mkdir ../build/doxygen')
    call('mkdir ../build/doxygen/doxygen')
    call('mv ../build/html ../build/doxygen')
...
# latex_documents = [
#     (master_doc, 'libROM.tex', 'libROM Documentation',
#      'Lawrence Livermore National Security, LLNS', 'manual'),
# ]
...
# man_pages = [
#     (master_doc, 'librom', 'libROM Documentation',
#      [author], 1)
# ]
...
# texinfo_documents = [
#     (master_doc, 'libROM', 'libROM Documentation',
#      author, 'libROM', 'One line description of project.',
#      'Miscellaneous'),
# ]
